...
It then calculates the Eye Aspect Ratio (EAR) for both eyes. The EAR is a mathematical ratio derived from the distances between these landmarks. The value is relatively constant when an eye is open and drops sharply towards zero when it closes.
